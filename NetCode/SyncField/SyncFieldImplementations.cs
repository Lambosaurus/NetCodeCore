...
namespace NetCode.SyncField
{
    public class SynchronisableEnum : SynchronisableField
    {
        ...
        protected override void Skip(byte[] data, ref int index) { index += sizeof(byte); }
    }
    ...
    public class SynchronisableShort : SynchronisableField
    {
        ...
        protected override void Skip(byte[] data, ref int index) { index += sizeof(short); }
    }
    ...
    public class SynchronisableUShort : SynchronisableField
    {
        ...
        protected override void Skip(byte[] data, ref int index) { index += sizeof(ushort); }
    }
    ...
    public class SynchronisableInt : SynchronisableField
    {
        ...
        protected override void Skip(byte[] data, ref int index) { index += sizeof(int); }
    }
    ...
    public class SynchronisableUInt : SynchronisableField
    {
        ...
        protected override void Skip(byte[] data, ref int index) { index += sizeof(uint); }
    }
    ...
    public class SynchronisableLong : SynchronisableField
    {
        ...
        protected override void Skip(byte[] data, ref int index) { index += sizeof(long); }
    }
    ...
    public class SynchronisableULong : SynchronisableField
    {
        ...
        protected override void Skip(byte[] data, ref int index) { index += sizeof(ulong); }
    }
    ...
    public class SynchronisableFloat : SynchronisableField
    {
        ...
        protected override void Skip(byte[] data, ref int index) { index += sizeof(float); }
    }
    ...
    public class SynchronisableDouble : SynchronisableField
    {
        ...
        protected override void Skip(byte[] data, ref int index) { index += sizeof(double); }
    }
    ...
    public class SynchronisableString : SynchronisableField
    {
        ...
        protected override void Skip(byte[] data, ref int index) { Primitive.ReadString(data, ref index); }
    }
    ...
    public class SynchronisableHalf : SynchronisableField
    {
        ...
        protected override void Skip(byte[] data, ref int index) { index += Primitive.SizeofHalf; }
    }
    ...
    public class SynchronisableByteArray : SynchronisableField
    {
        ...
        protected override void Skip(byte[] data, ref int index) { Primitive.ReadByte(data, ref index); }
    }
}
