...
{
    internal interface IPacketWritable
    {
        /// <summary>
        ...
        void WriteToPacket(byte[] data, ref int index, uint packetID);
    ...
    internal interface IPacketReadable
    {
        /// <summary>
        ...
        void ReadFromPacket(byte[] data, ref int index, uint packetID);
    }
}
